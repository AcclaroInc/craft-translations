...
### Fixed
- An issue where target content was missing after merging into draft ([AcclaroInc#486](https://github.com/AcclaroInc/pm-craft-translations/issues/486))
- An issue where exported redactor links were missing some required data ([AccclaroInc#491](https://github.com/AcclaroInc/pm-craft-translations/issues/491))
- An issue where entry was missing assets fields after merging into draft ([AcclaroInc#489](https://github.com/AcclaroInc/pm-craft-translations/issues/489))
- An issue where seomatic image field missing after merge into draft ([AcclaroInc#371](https://github.com/AcclaroInc/craft-translations/issues/371))
...
- An issue where category drafts were missing content from non-localized blocks and draft titles were updated but not saved.
...
- The disable logging behaviour changed from only disabling api calls to completely disabled plugin logs ([AcclaroInc#363](https://github.com/AcclaroInc/craft-translations/issues/363))
